...
Dijkstra算法，不用想了，下面的代码就是`最简洁的Dijkstra`
...
每当算法开始，**都从start点开始遍历周围的点**，不断的更新最从<u>start到某一点的**最短距离**</u>。如果发现距离**更短**，则将该点**存入PriorityQueue中**，等待下一次`以该点作为中间节点`，更新从start到别的点的最小距离
